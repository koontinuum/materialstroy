  ...
  return (
    <div className="mt-[100px] pb-[100px]">
      <div className="flex justify-between items-center px-[32px]">
        ...
        <a className="text-[#2e2e2e] font-bold max-sm:text-sm" href="/category">
          НА ГЛАВНУЮ
        </a>
      </div>
      <div className="w-full items-center gap-1 flex flex-col sm:flex-wrap sm:flex-row md:justify-center max-md:justify-center ">
